...
export const api = {
  ...
  async getPlants() {
    ...
    const { data, error } = await supabase
      .from('plants')
      .select('id, name, species, description, age_description, size_description, health_status, watering_frequency_days, watering_frequency_unit, light_requirements, humidity_requirements, special_instructions, location_notes, is_active, created_at, updated_at')
